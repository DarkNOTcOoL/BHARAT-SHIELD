...
// In dev, vite.config.js proxies /api to FastAPI on :8000, so no absolute host is needed.
// Set VITE_API_BASE at build time if the frontend and API are deployed on different origins.
